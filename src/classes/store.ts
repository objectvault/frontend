...
export class Store {
  ...
  public isValid(): boolean {
    return this._id != null && this._organization != null && this._alias != null;
  }

  public isEqual(o: Store, full = false): boolean {
    if ((o == null) || !o.isValid() || !this.isValid()) {
      return false;
    }

    // Test Equality (NOTE: Name is never used)
    let e: boolean = o._id === this._id && o._organization === this._organization && o._alias === this._alias;
